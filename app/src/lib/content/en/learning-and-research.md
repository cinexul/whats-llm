...
But the same AI is also the tool in this whole book most likely to **lead you into a ditch.** That year, that quotation, that data point it gives you may be **made up on the spot**, fabricated with names and details, looking the part, and you believe it before you know it and write it into your homework or report.
...
Let's start with the addictive side. AI has a few "natural talents" in learning scenarios, all closely matched to its nature of "continues, doesn't tire, doesn't mind."
...
| **Quiz you** | "Write 5 questions on this content to test me" "Grade and explain after I answer" | It can generate questions on the spot and give instant feedback, better than staring at the book |
...
> **Key point:** Think of AI as a **tireless reading buddy**: you can ask follow-ups endlessly, demand it rephrase, have it quiz you. But remember, it's a buddy who "explains well," not a teacher who "knows the standard answer." Its explaining "posture" is very professional, but the "facts" it states deserve a question mark. The next section covers exactly this boundary.
...
- Worse still: **the more fluent and confident it sounds, the less that means it's more reliable.** Fluent and confident only mean it "continued smoothly," nothing to do with "whether it's true."

Bring the metaphor back to reality: it's not a librarian who "opens the book for you," it's a chatty person who "recounts from impression and fills in the gaps when the impression is fuzzy." Right recounting means it got lucky and that impression was firm; wrong recounting, and it **doesn't know it's wrong either**, recounting just as righteously.
...
> **Key point:** This is why "it can be a reading buddy, not a source of facts", with explaining and quizzing, an error you can spot on the spot and it's harmless; but take the **year, quotation, or data** it gives and write it into a report, and you may not catch the error, and you'll take it as "it said so, must be right." **The more important, and the more it rattles a hard fact off, the more you must verify it against the original source by hand.** This is a bottom line, not a suggestion.
...
- **"What's the basis for this claim?"**, if it can't give a presentable source, or the source turns out not to exist on checking, that's an alarm.
...
| It says it with confidence, so it must be true | The more fluent and confident the less that means reliable, it only means it "continued smoothly," not that it "said it right" |
...
| It gave a link, so there's a basis | The link may be real but the content may not support its claim; you must open and check it (and web features differ by vendor, check the official docs) |
...
- Web / link-giving features differ by vendor, check the official docs; **a link existing does not equal the content being confirmed**, you still have to open and check.
...
1. **[Basic · Concept]** Which of these is best handed to AI?
   ...
   > **Answer: B.** Rephrasing and drawing analogies are "organizing and expressing," exactly its strength, and an error you can spot on the spot. A, C, and D are all "verifiable hard facts," precisely where it most easily fills in gaps and most burns you, these must be checked against the original source yourself.
...
3. **[Advanced · Misconception]** "It answered especially fluently and confidently, so the facts this time should be reliable." What's wrong?
   ...
   - B. Fluent and confident only mean it "continued smoothly," nothing to do with "whether it's true," and the more it rattles off the more you should watch out
   - C. The mistake is it didn't actually answer fluently enough
   - D. The mistake is you should make it answer more slowly
   > **Answer: B.** This is the most counterintuitive yet most worth-remembering point: fluency and correctness have no causal link. Many people are fooled precisely by its assured tone and take a fabricated quotation as real. Carve "the more confident the more you verify by hand" into habit and you won't trip over this.
