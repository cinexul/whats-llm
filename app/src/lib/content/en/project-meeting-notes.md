...
> **Key point:** **The to-dos and owners must be checked by you, line by line, by hand, before they go out.** This is the bottom line this chapter won't budge on. The reason: if other parts of the notes are wrong, at most the wording is off; but "**who's responsible for what, due when**," this kind of to-do, once it's wrong (it pins Zhang San's task on Li Si, or simply invents a task no one mentioned), once these notes go out they **really mislead people and cause real harm**. It might **mishear** (transcripts are error-prone to begin with) and it might **invent** (the hallucination from Chapter 9). So: the notes you can have it generate, **but the to-dos and owners column is what you sign your name to, and you must check every line yourself before it goes out.**
...
- **An AI**: as long as it can read long text and tidy by the format you give. It can be an AI chat product, or a coding agent that acts on your files (**the form varies, check the official docs**, Chapter 24).
- **A notes template you've decided on**: this is the key prop of this chapter, and Step 1 below makes it specifically.
- **A mental readiness to check**: treat "checking the to-dos and owners line by line before they go out" as the **last step you can't skip** in this task, like always checking the address before mailing a package.
...
You can't make a meal without rice. Before tidying, get the source you're feeding it complete and full.
...
**What you need to confirm:**
- Have it **"point each to-do back" to its source**, and you go through them one by one along the sources. **The ones that don't match the source are what it invented or misheard**; change or delete them on the spot.
...
- **Skipping the check and mass-sending directly.** This is the most serious pitfall of this chapter. It can write a fake to-do that looks exactly like a real one. **Not checking to-dos and owners line by line before sending is handing its "mishearing and invention" straight to your colleagues.**
...
Once you've got the basics down, you can make this "assistant" fit your hand better (all still the same old routine of "give a template, feed the source, check"):
...
- **Distill the template and the checklist into a "standard operating procedure"**: so the next person who tidies follows it too. Whether to make it into a more automated process, take it as far as you can manage, and **the specifics are subject to the official docs.**

> **Key point:** However fancy "taking it one step further" gets, that red line doesn't retreat one step: **any output that lands on "who should do what," whether a to-do list or a notification email, must be checked by hand line by line before it goes out.** A template helps you standardize the format and get the work done faster, but **"being responsible for the content" is something AI can't do for you.** It fills in, you sign your name.
...
- **The red line that won't budge: the to-dos and owners must be checked by hand line by line before they go out.** It might **mishear** (transcript error) or **invent** (hallucination), and this kind of mistake, once out, **causes real harm.**
- The crux of checking is to have it **"point each to-do back to its source"**; the ones that don't match are wrong, change or delete them on the spot; mark uncertain ones honestly as "not specified / to be confirmed," don't force-fill.
...
2. **[Basic · Concept]** What is this chapter's "red line that won't budge"?
   ...
   - B. The to-dos and owners must be checked by hand line by line before they go out
   - C. The notes must be over a thousand words
   - D. You must be online to tidy
   > **Answer: B.** A mistake elsewhere is at most off wording, but "who's responsible for what, due when," this kind of to-do, once it's wrong (it misheard or invented), once the notes go out it really misleads people and causes real harm. The to-dos and owners column is what you sign your name to, and you must check every line yourself before it goes out.
...
4. **[Advanced · Scenario]** When checking the to-dos, what's the most efficient and reliable way?
   ...
   - B. Have it "point each to-do back" to the matching sentence in the source, and you check line by line along the sources; the ones that don't match are what it invented or misheard
   - C. Delete the notes and regenerate them ten times
   - D. Only check whether the format is right
   > **Answer: B.** Have it "prove its source," and you can check line by line against the source: did someone really bring this up? Is the owner this person? Is the time something it added itself? The ones that don't match the source, change or delete on the spot. This is far more reliable than going by feel.
